# Find_Default_Capstone
Credit Card Fraud Detection Model

# Prediction of Credit Card Fraud

**Author**: Raghav Giroti
...
A credit card is one of the most used financial products for online purchases and payments. However, it also presents risks, such as fraud. Credit card fraud involves unauthorized transactions, leading to financial losses for individuals and institutions.

This unauthorized use not only leads to financial losses for consumers but also poses significant challenges for credit card companies in identifying and preventing fraudulent transactions.
...
- **Model Training and Evaluation**: Training and evaluating various classifiers, including AdaBoost and Random Forest, using metrics such as confusion matrices, classification reports, ROC-AUC scores, and ROC curves.
